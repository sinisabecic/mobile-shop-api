                        ...
                        <div class="dropdown">
                            <a class="nav-link" href="#">
                                ...
                                <div class="dropdown-content">
                                    ...
                                    ?>
                                    <a href="/category.php?id=<?php echo $result['catId']; ?>">
            ...
            if ($login == true) { ?>
                ...
                <form class="form-inline my-2 my-lg-0" action="search.php" method="get">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item nav-link">
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="?cid=<?php Session::get('cmrId') ?>">
                        ...
                        <li class="nav-item nav-link">
                            <input class="form-control mr-sm-2" name="search" type="text" id="mySearch"
                                onkeyup="myFunction()" placeholder="Nađi proizvode...">
